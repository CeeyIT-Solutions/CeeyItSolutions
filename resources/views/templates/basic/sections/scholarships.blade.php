  ...
  <div class="d-flex justify-content-center align-items-center" style="height: calc(100vh - 200px);">
    <div class="card shadow-lg p-4"
      ...
      <form action="{{ route('scholarship.apply') }}" method="POST" style="width: 100%;">
        ...
        <p class="mt-4 text-center">We are no longer accepting applications for the scholarship program. Thank you for
          your interest!</p>
      ...
      <form action="{{ route('scholarship.apply') }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <select class="form-select" id="occupation" name="occupation" required>
            ...
            <option value="it_professional" {{ old('occupation')==='it_professional' ? 'selected' : '' }}>IT
              Professional</option>
            <option value="non_it_professional" {{ old('occupation')==='non_it_professional' ? 'selected' : '' }}>Non-IT
              Professional</option>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="interest" name="interest" rows="3"
            required>{{ old('interest') }}</textarea>
        </div>
        <div class="mb-3">
          <label for="challenges" class="form-label">What challenges have you faced in transitioning to tech?</label>
        ...
        <div class="mb-3">
          ...
          <select class="form-select" id="tech_experience" name="tech_experience" required>
            <option value="" disabled {{ old('tech_experience') ? '' : 'selected' }}>Select an option</option>
        ...
        <div id="tech_experience_details" class="mb-3 {{ old('tech_experience') === 'Yes' ? '' : 'd-none' }}">
          <label for="tech_experience_details_input" class="form-label">If yes, provide additional details.</label>
          <textarea class="form-control" id="tech_experience_details_input" name="tech_experience_details"
            rows="3">{{ old('tech_experience_details') }}</textarea>
        </div>
        <div class="mb-3">
          <label for="goals" class="form-label">How will this scholarship help you achieve your goals?</label>
