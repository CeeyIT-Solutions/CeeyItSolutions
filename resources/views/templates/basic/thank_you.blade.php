	...
	<div class="body">
		<div class="main">
			<div class="container mx-auto p-4">
                <div class="donation-container bg-white p-5 shadow rounded text-center">
                    <div class="mb-4">
                        <svg class="bi bi-check-circle text-success" width="60" height="60" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zM8 0a8 8 0 1 1 0 16A8 8 0 0 1 0 8a8 8 0 0 1 8-8z"/>
                            <path d="M10.97 4.97a.235.235 0 0 1 .07.165v.07a.23.23 0 0 1-.07.165l-4 4a.23.23 0 0 1-.33 0l-2-2a.23.23 0 0 1 0-.33l.07-.07a.23.23 0 0 1 .33 0L7 8.29l3.63-3.62a.23.23 0 0 1 .33 0z"/>
                        </svg>
                    </div>
                    <h1 class="fw-bold text-dark">Thank You for Your Donation!</h1>
            
                    <div class="mt-4 p-3 bg-light rounded shadow-sm text-start">
                        <h5 class="fw-bold text-dark">Donation Details</h5>
                        <hr>
                        <p><strong>Name:</strong> {{ $Donation->name }}</p>
                        <p><strong>Email:</strong> {{ $Donation->email }}</p>
                        <p><strong>Phone:</strong> {{ $Donation->phone }}</p>
                        <p><strong>Amount:</strong> <span class="text-success fw-bold">${{ number_format($Donation->amount, 2) }}</span></p>
                        <p><strong>Transaction ID:</strong> <span class="text-muted">{{ $Donation->transaction_id }}</span></p>
                    </div>
            
                    <a href="/" class="btn btn-signup mt-4 w-100">Go to Homepage</a>
                </div>
            </div>            
		</div>
