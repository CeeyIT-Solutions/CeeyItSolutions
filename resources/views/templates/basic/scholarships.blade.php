            ...
            <div class="container mx-auto">
                <div class="hero-section">
                    ...
                    <div class="apply-btn-container">
                        <a href="{{ route('user.application.form') }}" class="btn apply-btn">Apply for scholarships <img
                                class="d-none d-sm-block ms-1" src="assets/images/arrow_up.svg" alt=""></a>
                        <a href="{{ route('laptops') }}" class="btn apply-btn-transparent">Sponsor a talent</a>
                    </div>
                </div>
