	...
	<div class="main">
		...
		<div class="hero-section">
			...
			<div class="apply-btn-container">
				<a href="{{route('scholarships')}}" class="btn apply-btn">Apply for scholarships <img class="d-none d-sm-block ms-1" src="assets/images/arrow_up.svg" alt=""></a>
		...
		<div class="info-section text-white">
			...
			<div class="card-bottom-padding">
				...
				<div class="apply-btn-container">
					<a href="{{route('laptops')}}" class="btn apply-btn">Apply for Laptop <img class="d-none d-sm-block ms-1" src="assets/images/arrow_up.svg" alt=""></a>
				</div>
			</div>
