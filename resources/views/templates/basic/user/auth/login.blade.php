    ...
    <div class="container-fluid  px-md-4 pb-5 d-flex justify-content-center align-items-center vh-100 "
        ...
        <div class="row align-items-center" style="max-width: 600px; width: 100%;">
            ...
            <div class="d-flex flex-column justify-content-center"
                ...
                <h1 class="title-header text-center mb-4" style="font-size: 2rem; font-weight: bold; color: #343a40;">Sign
                    in to
                    continue</h1>
                <form class="row g-4 login-form" method="POST" action="{{ route('user.login') }}"
                    ...
                    @csrf
                    <div class="col-md-12">
                        <label for="username" class="form-label" style="font-weight: 600; color: #495057;">Username or
                            Email</label>
                    ...
                    <div class="col-md-12 position-relative">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control text-input" id="password" name="password"
                                placeholder="******" required style="border-radius: 8px;">
