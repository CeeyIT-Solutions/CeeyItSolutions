                        ...
                        <tbody>
                            @forelse($applications as $key => $data)
                                                        <tr>
                                                            ...
                                                            @php
                                                                $occupation = $data['occupation'] == 'non_it_professional' ? 'Non IT Professional' : 'IT Professional';
                                                                if ($data['approval_status'] == 0) {
                                                                    $status = 'Pending';
                                                                } elseif ($data['approval_status'] == 1) {
                                                                    $status = 'Accepted';
                                                            ...
                                                            <td>
                                                                ...
                                                                <button class="btn btn-primary view-btn" data-id="{{ $data['application_id'] }}"
                                                                    ...
                                                                    data-phone="{{ $data['phone'] }}" data-course="{{ $data['course']['title'] }}"
                                                                    data-occupation="{{ $occupation}}" data-status="{{ $status}}"
                                                                    data-interest="{{$data['interest']}}" data-challenges="{{$data['challenges']}}"
    ...
    <div class="modal fade" id="confirmApprovalModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-success" id="confirmApprovalButton">Confirm Approval</button>
                </div>
            </div>
        </div>
    </div>
...
@push('breadcrumb-plugins')
    ...
    <button type="button" id="sendSlackInvite" value="1" class="btn btn--info ml-2 mr-2 mb-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-slack" style="width: 20px;color:white"
    ...
    <form action="" method="GET" class="form-inline float-sm-right bg--white">
        <div class="input-group has_append">
            <input type="text" name="search" style="width:300px;" class="form-control"
                placeholder="@lang('Search by id , name ,  email or phone....')" value="{{$keyword ?? ''}}"
                autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <form id="courseForm" action="{{ route('admin.invite.send') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <br>
                        <select id="courseSelect" name="course_id" class="form-select" required style="width: 100%;">
